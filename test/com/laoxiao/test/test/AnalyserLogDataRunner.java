...
//            ToolRunner.run(new Configuration(), new AnalyserLogDataRunner(), args);
            ToolRunner.run(new Configuration(), new AnalyserLogDataRunner(), new String[]{});
        } catch (Exception e) {
...
//        this.conf.set("hbase.zookeeper.quorum", "192.168.1.251");
        this.conf.set("hbase.zookeeper.quorum", "node2");
    }
...
//         TableMapReduceUtil.initTableReducerJob(EventLogConstants.HBASE_NAME_EVENT_LOGS, null, job);
        ...
        TableMapReduceUtil.initTableReducerJob("event_log", MyTableReducer.class, job, null, null, null, null, false);
...
//            Path inputPath = new Path("/flume/" + TimeUtil.parseLong2String(TimeUtil.parseString2Long(date), "MM/dd/"));
            Path inputPath = new Path("/flume/data/2015-04-27");
