 ...
 * @author 肖斌
 * 
 * Comments :: need create this table event_log in Hbase manual ,the process not created it by self
 *
 *hbase(main):006:0> count "event_log" to verify the loaded data  => 50000
 *INFO - 输入数据:70000；输出数据:60000；过滤数据:10000
 */
...
//            Path inputPath = new Path("/flume/" + TimeUtil.parseLong2String(TimeUtil.parseString2Long(date), "MM/dd/"));
            ...
            Path inputPath = new Path("/access2.log");
